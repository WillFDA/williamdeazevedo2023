...
export default function TechnoComponents(props) {
  ...
  return (
    <motion.div
    className="p-4 bg-gray-200 rounded-3xl flex flex-col justify-between relative overflow-hidden gap-4 hover:bg-gray-300 transition-colors duration-300 min-h-[12rem] sm:min-h-[14rem] md:min-h-[16rem] lg:min-h-[15rem] xl:min-h-[17rem] sm:p-6 md:p-8 w-full md:w-1/2"
